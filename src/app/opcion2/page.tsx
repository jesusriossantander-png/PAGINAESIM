  ...
  return (
    <>
      <p className={`flex items-center gap-3 text-sm font-extrabold tracking-wider uppercase ${claro ? "text-white" : "text-neutral-900"}`}>
        <span className="h-3 w-3 bg-rojo-500" />
        {eyebrow}
      </p>
...
export default function Opcion2() {
  return (
    <>
      {/* HERO */}
      <section id="inicio" className="relative flex min-h-[calc(100svh-124px)] items-center overflow-hidden bg-neutral-900 text-white">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 pt-16 pb-40">
          <Reveal className="max-w-3xl">
            ...
            <a href="#servicios" className="mt-9 inline-flex items-center gap-3 bg-rojo-500 px-8 py-4 font-extrabold tracking-wide uppercase transition hover:bg-rojo-600">
          ...
          <div className="mx-auto grid max-w-7xl grid-cols-1 divide-y divide-white/10 px-6 sm:grid-cols-3 sm:divide-x sm:divide-y-0">
            {["Acondicionamiento de ductos", "Equipos rotativos", "Oficina técnica y 3D"].map((t) => (
              <a key={t} href="#servicios" className="flex items-center gap-3 py-5 font-bold sm:justify-center">
                <span className="grid h-7 w-7 place-items-center rounded-full bg-rojo-500 text-xs">✓</span>
                {t}
              </a>
            ))}
          </div>
        ...
        <div className="mx-auto grid max-w-7xl items-stretch gap-8 px-6 lg:grid-cols-2">
          <Reveal className="bg-white p-8 md:p-12">
            ...
            <div className="mt-8 grid gap-8 sm:grid-cols-[auto_1fr] sm:items-center">
              <div className="grid h-36 w-36 place-items-center bg-rojo-500 text-center text-white">
                <div>
            ...
            <Link href="/empresa" className="mt-10 inline-block bg-neutral-900 px-7 py-3.5 text-sm font-extrabold tracking-wide text-white uppercase transition hover:bg-rojo-500">
              Conocé más
            </Link>
          </Reveal>
          <Reveal delay={120} className="relative min-h-[420px] overflow-hidden">
            ...
            <Link href="/obras" aria-label="Ver trabajos" className="absolute top-6 right-6 grid h-16 w-16 place-items-center bg-rojo-500 text-2xl text-white transition hover:bg-rojo-600">
              ↗
            </Link>
          </Reveal>
        </div>
      ...
      <section id="bases" className="scroll-mt-24 bg-white py-24">
        <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-[1.1fr_1fr]">
          ...
          <Reveal delay={120}>
            ...
            <p className="mt-6 leading-relaxed text-neutral-600">
              Bases en cuatro ciudades para llegar rápido a cada yacimiento y planta. Pasá el mouse por un punto rojo para ver el detalle.
            </p>
            <ul className="mt-8 grid gap-3 sm:grid-cols-2">
              {bases.map((b) => (
                <li key={b.id} className="border-l-4 border-rojo-500 bg-neutral-100 px-5 py-4">
                  <p className="font-extrabold">{b.ciudad}</p>
                  <p className="text-sm text-neutral-500">
                    {b.sitios.map((s) => s.nombre).join(" · ")}
                  </p>
                </li>
              ))}
            </ul>
      ...
      <section className="relative overflow-hidden bg-neutral-900 py-24 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-2">
          <Reveal>
            ...
            <a href="#contacto" className="mt-9 inline-block bg-rojo-500 px-7 py-3.5 text-sm font-extrabold tracking-wide uppercase transition hover:bg-rojo-600">
              Hablemos
            </a>
          </Reveal>
            ...
            {[
              ...
              <div key={t} className="border border-white/15 bg-white/5 p-6 backdrop-blur">
                <p className="flex items-center gap-3 font-extrabold">
                  <span className="h-2.5 w-2.5 rounded-full bg-rojo-500" />
                  {t}
                </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {servicios.map((s, i) => (
              <Reveal key={s.slug} delay={i * 70}>
                ...
                >
                  ...
                  <span className="absolute top-0 right-0 grid h-12 w-12 place-items-center bg-rojo-500 text-xl text-white transition group-hover:h-14 group-hover:w-14">↗</span>
                  <span className={`relative ${i === 0 ? "text-white" : "text-rojo-500 group-hover:text-white"}`}>
                    <Icono nombre={s.slug} />
                  </span>
            ...
            <Reveal delay={servicios.length * 70}>
              <a href="#contacto" className="group relative flex h-full min-h-72 flex-col bg-rojo-500 p-8 text-white transition hover:bg-rojo-600">
              ...
              {indicadores.map((b) => (
                <div key={b.label}>
                  ...
                  <div className="mt-2 h-2 bg-neutral-300">
                    <div className="bar h-full bg-rojo-500" style={{ width: `${b.value}%` }} />
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="relative overflow-hidden bg-neutral-900 py-28 text-center text-white">
        ...
        <Reveal className="relative mx-auto max-w-3xl px-6">
          <p className="text-sm font-extrabold tracking-wider text-rojo-500 uppercase">Sumate al equipo</p>
          ...
          <Link href="/trabaja-con-nosotros" className="mt-9 inline-block bg-rojo-500 px-8 py-4 font-extrabold tracking-wide uppercase transition hover:bg-rojo-600">
      ...
      <section id="proyectos" className="scroll-mt-24 bg-white py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-wrap items-end justify-between gap-6">
            ...
            <Link href="/obras" className="border-2 border-neutral-900 px-6 py-3 text-sm font-extrabold tracking-wide uppercase transition hover:bg-neutral-900 hover:text-white">
              Ver todos
            </Link>
          </div>
          <div className="mt-14 grid gap-8 md:grid-cols-3">
            {proyectos.map((p, i) => (
              <Reveal key={p.titulo} delay={i * 90} className="group">
                ...
                <Link href="/obras" className="mt-5 inline-block bg-rojo-500 px-5 py-2.5 text-xs font-extrabold tracking-wide text-white uppercase transition hover:bg-rojo-600">
                  Ver más
                </Link>
              </Reveal>
            ))}
      ...
      {/* COTIZACIÓN */}
      <section id="contacto" className="scroll-mt-24 bg-rojo-500 text-white">
